...
if debug_val:
	os.system('vsim -c work.tb_fm_seq -do "run -all" +START=' + str(start_image) + ' +STOP=' + str(end_image) + ' +define+DEBUG_MODE');
else:
	os.system('vsim -c work.tb_fm_seq -do "run -all" +START=' + str(start_image) + ' +STOP=' + str(end_image));
